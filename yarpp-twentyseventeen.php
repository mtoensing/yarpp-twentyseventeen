...
function yarpp_twentyseventeen_scripts() {
	...
	wp_enqueue_script(
		'jquery.yarpp-init',WP_PLUGIN_URL . "/yarpp-twentyseventeen/jquery.unveil-init.js", array( "jquery", "jquery.unveil" ),1.8,true );


	wp_enqueue_style(
		"yarpp-template-thumbnails",WP_PLUGIN_URL . "/yarpp-twentyseventeen/yarpp-template.css",false,1.8 );
